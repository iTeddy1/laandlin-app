          ...
          <Modal.Body>
            ...
            <View className="divide-y">
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Inventory items only</Text>
                <Switch
                  value={filters.inStock}
                  onValueChange={value =>
                    handleFilterChange({ name: 'inStock', type: 'checkbox', value })
                  }
                />
              </View>
              <View className="flex flex-row justify-between items-center py-2.5">
                <Text className="font-medium text-gray-700 w-3/4">Special offer only</Text>
                <Switch
                  value={filters.discount}
                  onValueChange={value =>
                    handleFilterChange({ name: 'discount', type: 'checkbox', value })
                  }
                />
              </View>
              ...
              <View className="py-4">
                ...
                <View className="flex flex-row items-center justify-between gap-x-1">
                  ...
                  <TextInput
                    ...
                    name="minPrice"
                    onChangeText={value =>
                      handleFilterChange({ name: 'minPrice', type: 'input', value })
                    }
                  />
                  <Text className="w-6 h-6 text-sm">VND</Text>
                </View>
                <View className="flex flex-row items-center justify-between mt-2 mb-4 gap-x-1">
                  ...
                  <TextInput
                    ...
                    name="maxPrice"
                    onChangeText={value =>
                      handleFilterChange({ name: 'maxPrice', type: 'input', value })
                    }
                  />

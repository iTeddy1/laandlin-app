    ...
    extend: {
      colors: {
        ...
        text: {
          ...
          error: 'rgb(var(--color-text-error))',
          success: 'rgb(var(--color-text-success))',
          warning: 'rgb(var(--color-text-warning))',
          info: 'rgb(var(--color-text-info))',
          typography: 'rgb(var(--color-text-typography))',
          outline: 'rgb(var(--color-text-outline))',
          background: 'rgb(var(--color-text-background))',
          white: 'rgb(var(--color-text-white))',
          gray: 'rgb(var(--color-text-gray))',
          black: 'rgb(var(--color-text-black))',
        },

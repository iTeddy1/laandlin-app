...
router.post('/upload', validateToken, verifyRoles(['admin', 'manager']), upload.single('image'), controller.uploadImage);
router.post('/upload-many', validateToken, verifyRoles(['admin', 'manager']), upload.array('images', 10), controller.uploadManyImages);

...
router.get('/unverified/:productId', validateToken, verifyRoles(["admin", "manager"]), reviewController.getUnverifiedReviewsByProductId);
router.get('/product/:productId', reviewController.getReviewByProductId);

router.patch('/verify-many', validateToken, verifyRoles(['admin', 'manager']), reviewController.verifyManyReviews);
router.get('/unverified', validateToken, verifyRoles(["admin", "manager"]), reviewController.getAllUnverifiedReviews);
router.get('/verified', validateToken, verifyRoles(["admin", "manager"]), reviewController.getAllVerifiedReviews);
